        ...
        <div class="firstSection" style="max-width: 844px; width: 100%; margin: 0 auto; ">
                ...
                <div style="padding: 0px 10px 73px 10px;">
                    ...
                    <div style="margin-top: 27px; text-align: center;">
                        <a href="" target="_blank" class="socialBtn"
                            ...
                            <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/twitter.png"
                                style="width: 100%; height: 100%;" alt="">
                        </a>
                        <a href="" target="_blank" class="socialBtn"
                            style="display: inline-block; border-radius: 5px; background: rgba(0, 0, 0, 0.80); vertical-align: middle;padding: 10px;">
                            <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/facebook.png"
                                style="width: 100%; height: 100%;" alt="">
                        </a>
                        <a href="" target="_blank" class="socialBtn"
                            style="display: inline-block; border-radius: 5px; background: rgba(0, 0, 0, 0.80); vertical-align: middle;padding: 10px;">
                            <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/whatsup.png"
                                style="width: 100%; height: 100%;" alt="">
                        </a>
                        <a href="" target="_blank" class="socialBtn"
                            style="display: inline-block; border-radius: 5px; background: rgba(0, 0, 0, 0.80); vertical-align: middle;padding: 10px;">
                            <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/discord.png"
                                style="width: 100%; height: 100%;" alt="">
                        </a>
                        <a href="" target="_blank" class="socialBtn"
                            style="display: inline-block; border-radius: 5px; background: rgba(0, 0, 0, 0.80); vertical-align: middle;padding: 10px;">
                            <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/email.png"
                                style="width: 100%; height: 100%;" alt="">
                        </a>
                    </div>
                </div>
            ...
            <div style="margin-top: 30px; text-align: center;">
                <a href="" target="_blank"
                    ...
                    <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/fu/instagram.png"
                        style="width: 30px; height: 30px;" alt="">
                </a>
                <a href="" target="_blank"
                    style="display: inline-block; width: 30px; height: 30px; vertical-align: middle; margin: 0 25px 25px 0;">
                    <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/fu/tiktok.png"
                        style="width: 30px; height: 30px;" alt="">
                </a>
                <a href="" target="_blank"
                    style="display: inline-block; width: 30px; height: 30px; vertical-align: middle; margin: 0 25px 25px 0;">
                    <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/fu/discord.png"
                        style="width: 30px; height: 30px;" alt="">
                </a>
                <a href="" target="_blank"
                    style="display: inline-block; width: 30px; height: 30px; vertical-align: middle; margin: 0 25px 25px 0;">
                    <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/fu/twitter.png"
                        style="width: 30px; height: 30px;" alt="">
                </a>
                <a href="" target="_blank"
                    style="display: inline-block; width: 30px; height: 30px; vertical-align: middle; margin: 0 25px 25px 0;">
                    <img src="http://localhost:8000/api/v1/uploads/src/assets/icons/fu/reddit.png"
                        style="width: 30px; height: 30px;" alt="">
                </a>
            </div>
